    ...
    <form id="mainContent" method="POST" action="preferences" style = "gap: 0">
        ...
        <div class="preferences">
            ...
            <div id="themesContainer" class="theme-row-container">
                <div>
                    <h1 id="preferenceHeader" style = "line-height: 0">color theme<i class="fa-solid fa-palette"></i></h1>
                </div>
            ...
            <div id="switchesContainer" class="rowContainer">
                <h1 class="notSignedIn" id="preferenceHeader" style = "line-height: 0">keyboard switch sounds<i class="fa-solid fa-volume-low"></i></h1>
            ...
            <div id="caretsContainer" class="rowContainer">
                <h1 class="notSignedIn" id="preferenceHeader" style = "line-height: 0">pace caret <i class="fa-solid fa-i-cursor"></i></h1>
            ...
            <div id="linesContainer" class="rowContainer">
                <h1 class="notSignedIn" id="preferenceHeader" style = "line-height: 0">lines <i class="fa-solid fa-align-left"></i></h1>
