    ...
    <form id="mainContent" method="POST" action="preferences" style = "gap: 0">
        ...
        <div class="preferences">
            ...
            <div id="fontsContainer" class="rowContainer">
                ...
                <a data-value="vt323" class="preference click" style="font-family: 'vt323', monospace;" onclick="setPreference('fontFamily', 'vt323'), addNotification('font family','vt323');">vt323</a>
