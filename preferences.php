...
<body>
    ...
    <form id="mainContent" method="POST" action="preferences" style = "gap: 0">
        ...
        <div class="preferences">
            <div id="sizesContainer" class="rowContainer lvl4">
            ...
            <div id="switchesContainer" class="rowContainer lvl4">
            ...
            <div id="themesContainer" class="theme-row-container lvl4">
                <div>
            ...
            <div id="linesContainer" class="rowContainer lvl4">
