...
<body>
    ...
    <form id="mainContent" method="POST" action="preferences" style = "gap: 0">
        ...
        <div class="preferences">
            <div id="sizesContainer" class="rowContainer lvl2">
            ...
            <div id="themesContainer" class="theme-row-container lvl2">
                <div>
            ...
            <div id="caretsContainer" class="rowContainer lvl2">
            ...
            <div id="linesContainer" class="rowContainer lvl2">
