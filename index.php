...
<body class="main-body">
    ...
    <div id="mainContent">
        ...
        -->
        <div id="testStats">
            <div class="statsContainer" style = "background-color: var(--rowBackground); margin: 2rem;">
            ...
            <?php } else { ?>
                <a id="showRestart" href="signup"><span id="saveProgress">login to save progress</a>
            <?php } ?>
