...
// Get the stats per day
$sqlDaily = "SELECT DATE(testTime) AS date, COUNT(*) AS daily_tests, AVG(wpm) AS daily_avg_wpm, AVG(accuracy) AS daily_avg_accuracy FROM typingtest WHERE id = ? GROUP BY DATE(testTime) ORDER BY DATE(testTime) DESC";
